...
public class EmployeeController {
    ...
    public ResponseEntity<Employee> addNewEmployee(
        ...
        try {
            ...
            logger.debug("TIMESTAMP:{}:Add New Employee:Validate Auth Token {}", System.currentTimeMillis(), oAuthToken);
            ...
            logger.info("TIMESTAMP:{}:Add New Employee:Id - {}:First Name - {}:Last Name - {}", System.currentTimeMillis(), employee.getId(), employee.getFirstName(), employee.getLastName());
